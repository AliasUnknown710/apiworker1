...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/apiworker1)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/apiworker1
```

A live public deployment of this template is available at [https://apiworker1.templates.workers.dev](https://apiworker1.templates.workers.dev)
